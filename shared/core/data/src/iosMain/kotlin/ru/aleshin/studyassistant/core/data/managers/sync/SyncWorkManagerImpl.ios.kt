 ...
 */
actual class SyncWorkManagerImpl : SyncWorkManager {

    actual override suspend fun fetchWorkStatus(): RepeatWorkStatus {
        return RepeatWorkStatus.NOT_PLANNED
    }

    actual override fun startOrRetrySyncService() = Unit

    actual override fun stopSyncService() = Unit
}