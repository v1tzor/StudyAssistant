 ...
 */
abstract class SingleSyncMapper<E : BaseLocalEntity, P : BaseRemotePojo>(
    val localToRemote: E.() -> P,
    val remoteToLocal: P.() -> E,
)

abstract class MultipleSyncMapper<E : BaseLocalEntity, P : BaseMultipleRemotePojo>(
    val localToRemote: E.(currentUser: UID) -> P,
    val remoteToLocal: P.() -> E,
)