 ...
 */
interface SharedSchedulesSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = SHARED_SCHEDULES_SOURCE_KEY

    companion object {
        const val SHARED_SCHEDULES_SOURCE_KEY = "SHARED_SCHEDULES"
    }
}