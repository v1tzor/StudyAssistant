 ...
 */
interface FriendRequestsSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = FRIEND_REQUESTS_SOURCE_KEY

    companion object {
        const val FRIEND_REQUESTS_SOURCE_KEY = "FRIEND_REQUESTS"
    }
}