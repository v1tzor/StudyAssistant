 ...
 */
interface CustomScheduleSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = CUSTOM_SCHEDULE_SOURCE_KEY

    companion object Companion {
        const val CUSTOM_SCHEDULE_SOURCE_KEY = "CUSTOM_SCHEDULE"
    }
}