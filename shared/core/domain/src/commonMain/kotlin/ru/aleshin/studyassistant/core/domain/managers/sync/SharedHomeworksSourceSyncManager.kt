 ...
 */
interface SharedHomeworksSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = SHARED_HOMEWORKS_SOURCE_KEY

    companion object {
        const val SHARED_HOMEWORKS_SOURCE_KEY = "SHARED_HOMEWORKS"
    }
}