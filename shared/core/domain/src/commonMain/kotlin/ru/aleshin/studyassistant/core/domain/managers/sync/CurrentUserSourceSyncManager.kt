 ...
 */
interface CurrentUserSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = CURRENT_USER_SOURCE_KEY

    companion object Companion {
        const val CURRENT_USER_SOURCE_KEY = "CURRENT_USER"
    }
}