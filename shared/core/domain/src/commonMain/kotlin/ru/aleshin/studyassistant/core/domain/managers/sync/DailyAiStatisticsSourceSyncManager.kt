 ...
 */
interface DailyAiStatisticsSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = DAILY_AI_STATISTICS_SOURCE_KEY

    companion object {
        const val DAILY_AI_STATISTICS_SOURCE_KEY = "DAILY_AI_STATISTICS"
    }
}