 ...
 */
interface HomeworkSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = HOMEWORK_SOURCE_KEY

    companion object {
        const val HOMEWORK_SOURCE_KEY = "HOMEWORK"
    }
}