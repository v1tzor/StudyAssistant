 ...
 */
interface SubjectsSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = SUBJECT_SOURCE_KEY

    companion object {
        const val SUBJECT_SOURCE_KEY = "SUBJECT"
    }
}