 ...
 */
interface OrganizationsSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = ORGANIZATIONS_SOURCE_KEY

    companion object {
        const val ORGANIZATIONS_SOURCE_KEY = "ORGANIZATION"
    }
}