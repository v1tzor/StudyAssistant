...
package ru.aleshin.studyassistant.core.domain.entities.share.scheules
 ...
 */
data class ReceivedMediatedSchedules(
    val uid: UID,
    val sendDate: Instant,
    val sender: AppUser,
    val schedules: List<MediatedBaseSchedule>,
    val organizationsData: List<MediatedOrganization>,
)