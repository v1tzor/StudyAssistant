 ...
 */
interface BaseScheduleSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = BASE_SCHEDULE_SOURCE_KEY

    companion object {
        const val BASE_SCHEDULE_SOURCE_KEY = "BASE_SCHEDULE"
    }
}