 ...
 */
interface EmployeeSourceSyncManager : SourceSyncManager {

    override val sourceSyncKey: SourceSyncKey get() = EMPLOYEE_SOURCE_KEY

    companion object {
        const val EMPLOYEE_SOURCE_KEY = "EMPLOYEE"
    }
}