...
package ru.aleshin.studyassistant.core.presentation.mappers.settings
 ...
 */
fun CalendarSettings.mapToUi() = CalendarSettingsUi(
...
fun CalendarSettingsUi.mapToDomain() = CalendarSettings(
    numberOfWeek = numberOfWeek,
    weekScheduleViewType = weekScheduleViewType,
