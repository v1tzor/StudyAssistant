...
package ru.aleshin.studyassistant.core.presentation.mappers.tasks
 ...
 */
fun HomeworkTasksDetails.mapToUi() = HomeworkTasksDetailsUi(
    origin = origin,
    components = components.map { it.mapToUi() },
)

fun HomeworkTasksDetailsUi.mapToDomain() = HomeworkTasksDetails(
    origin = origin,
