...
package ru.aleshin.studyassistant.core.presentation.models.organizations
...
@Immutable
@Serializable
data class ScheduleTimeIntervalsUi(
    ...
    fun minClassDuration(): Millis? {
        return min(specificClassDuration.minOfOrNull { it.duration }, baseClassDuration)
    }

    fun minBreakDuration(): Millis? {
        return min(specificBreakDuration.minOfOrNull { it.duration }, baseBreakDuration)
    }

    fun maxClassDuration(): Millis? {
        return max(specificClassDuration.maxOfOrNull { it.duration }, baseClassDuration)
    }

    fun maxBreakDuration(): Millis? {
        return max(specificBreakDuration.maxOfOrNull { it.duration }, baseBreakDuration)
    }
}
