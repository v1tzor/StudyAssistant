 ...
 */
@Serializable
data class BaseTodoEntity(
    override val uid: String,
    val deadline: Long?,
    val name: String,
    val description: String?,
    val priority: String,
    val notifyBeforeStart: Long,
    val notifyFifteenMinutesBefore: Long,
    val notifyOneHourBefore: Long,
    val notifyThreeHourBefore: Long,
    val notifyOneDayBefore: Long,
