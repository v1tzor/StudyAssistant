...
import ru.aleshin.studyassistant.core.remote.models.appwrite.FileListPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.FilePojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.ImageFormat
import ru.aleshin.studyassistant.core.remote.models.appwrite.ImageGravity
 ...
 */
class StorageService(client: AppwriteClient) : AppwriteService(client) {
...
internal fun InputFile.path(): Path {
    return Path(checkNotNull(uri))
}