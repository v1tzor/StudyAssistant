 ...
 */
interface AppStoreSubscriptionStatusProvider : SubscriptionStatusProvider<SubscriptionIdentifier.AppStore> {

    class Base(
        private val httpClient: HttpClient,
    ) : AppStoreSubscriptionStatusProvider {

        override suspend fun fetchStatus(identifier: SubscriptionIdentifier.AppStore): SubscriptionStatusPojo {
