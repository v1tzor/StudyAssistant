...
//import ru.aleshin.studyassistant.core.remote.models.users.NewAppUserPojo
//
///**
// * @author Stanislav Aleshin on 29.04.2024.
// */
//interface UsersRemoteDataSourceOld {
//
//    /**
...
//            if (uid.isEmpty()) throw FirebaseUserException()
//
//            val documents = appwriteDatabase.getDocument(
//                databaseId = "686052b2001b25f5a09f", // data
//                collectionId = "xxAGxrwB36eIWMKkUdElDAvWQzS2", // users
//                documentId = uid,
//                nestedType = NewAppUserPojo::class
//            )
//            Logger.i("test") { "user -> $documents" }
//
////            val realtime = appwriteRealtime.subscribe(
////                channels = listOf("databases.686052b2001b25f5a09f.collections.xxAGxrwB36eIWMKkUdElDAvWQzS2.documents"),
////                payloadType = AppUserPojo::class,
////            ) {
////                Logger.e("test") { "update -> ${it.payload}" }
////            }
//
