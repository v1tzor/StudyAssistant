 ...
 */
interface GooglePlaySubscriptionStatusProvider : SubscriptionStatusProvider<SubscriptionIdentifier.GooglePlay> {

    class Base(
        private val httpClient: HttpClient,
    ) : GooglePlaySubscriptionStatusProvider {

        override suspend fun fetchStatus(identifier: SubscriptionIdentifier.GooglePlay): SubscriptionStatusPojo {
