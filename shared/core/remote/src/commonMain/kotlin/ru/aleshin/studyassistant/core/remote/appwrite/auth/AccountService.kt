...
import ru.aleshin.studyassistant.core.remote.appwrite.utils.AuthenticationFactor
import ru.aleshin.studyassistant.core.remote.appwrite.utils.AuthenticatorType
...
import ru.aleshin.studyassistant.core.remote.models.appwrite.IdentityListPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.JwtPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.LogListPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.MfaChallengePojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.MfaFactorsPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.MfaRecoveryCodesPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.MfaTypePojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.PreferencesPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.SessionListPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.SessionPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.TargetPojo
import ru.aleshin.studyassistant.core.remote.models.appwrite.TokenPojo
...
class AccountService(
    ...
    suspend fun getCurrentUser(realtime: Boolean = false): AuthUserPojo? {
        ...
        val savedUserData = localCache.getStringOrNull(CURRENT_USER_KEY)?.tryFromJson(
            deserializer = AuthUserPojo.serializer(),
        )

        if (savedUserData != null) {
            if (isUpdated.value && !realtime) {
                return savedUserData
            } else {
                if (connectionManager.isConnected()) {
                    val actualUser = getUserFromServer()
                    if (actualUser?.emailVerification == true) {
                        localCache[CURRENT_USER_KEY] = actualUser.toJson(AuthUserPojo.serializer())
                        isUpdated.value = true
                    } else {
                        localCache[CURRENT_USER_KEY] = null
                    }
                    return actualUser
                } else {
                    return savedUserData
