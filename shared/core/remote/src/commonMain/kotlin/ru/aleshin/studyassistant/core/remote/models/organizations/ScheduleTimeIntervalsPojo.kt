 ...
 */
@Serializable
data class ScheduleTimeIntervalsPojo(
    val firstClassTime: Long? = null,
    val baseClassDuration: Millis? = null,
    val baseBreakDuration: Millis? = null,
    val specificClassDuration: List<NumberedDurationPojo> = emptyList(),
    val specificBreakDuration: List<NumberedDurationPojo> = emptyList(),
)