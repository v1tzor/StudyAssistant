...
import ru.aleshin.studyassistant.core.domain.entities.settings.NotificationSettings.Companion.WORKLOAD_HIGH_VALUE

/**
 * @author Stanislav Aleshin on 22.08.2024.
 */
@Serializable
data class NotificationSettingsPojo(
    ...
    companion object {
        fun default() = NotificationSettingsPojo()
    }
}