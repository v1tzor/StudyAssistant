 ...
 */
@Serializable
abstract class BaseRemotePojo {

    /**
     * Unique identifier of the Appwrite document.
     *
     * Mapped from the Appwrite system field `$id`.
     */
    @SerialName("\$id")
    abstract val id: String

    /**
     * The timestamp (in milliseconds since epoch) of the last update to the document.
     *
     * Used during synchronization to determine the freshness of the document
     * and resolve merge conflicts between local and remote data.
     */
