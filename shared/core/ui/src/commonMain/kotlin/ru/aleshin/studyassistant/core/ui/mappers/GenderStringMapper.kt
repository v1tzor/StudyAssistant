 ...
 */
fun Gender.mapToSting(strings: StudyAssistantStrings) = when (this) {
    Gender.NONE -> strings.noneGender
    Gender.FEMALE -> strings.femaleGender
    Gender.MALE -> strings.maleGender
}