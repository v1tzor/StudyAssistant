    ...
    companion object {
        fun specifySize(height: Dp, width: Dp) = WindowSize(
            widthWindowType = when {
                ...
                width < 600.dp -> WindowSize.WindowType.COMPACT
                width < 840.dp -> WindowSize.WindowType.MEDIUM
            ...
            heightWindowType = when {
                ...
                height < 680.dp -> WindowSize.WindowType.COMPACT
                height < 900.dp -> WindowSize.WindowType.MEDIUM
                else -> WindowSize.WindowType.EXPANDED
            },
