 ...
 */
internal interface OrganizationsEffectCommunicator : EffectCommunicator<OrganizationsEffect> {
    class Base : OrganizationsEffectCommunicator, EffectCommunicator.Abstract<OrganizationsEffect>()
}