 ...
 */
internal interface OrganizationsStateCommunicator : StateCommunicator<OrganizationsViewState> {
    class Base : OrganizationsStateCommunicator, StateCommunicator.Abstract<OrganizationsViewState>(
        defaultState = OrganizationsViewState()
    )
}