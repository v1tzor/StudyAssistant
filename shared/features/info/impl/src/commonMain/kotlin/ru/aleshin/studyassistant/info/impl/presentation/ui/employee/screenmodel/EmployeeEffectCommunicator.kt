 ...
 */
internal interface EmployeeEffectCommunicator : EffectCommunicator<EmployeeEffect> {
    class Base : EmployeeEffectCommunicator, EffectCommunicator.Abstract<EmployeeEffect>()
}