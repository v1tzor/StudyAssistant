 ...
 */
public class DefaultInfoFeatureStarter(
    private val dependenciesFactory: () -> InfoFeatureDependencies,
) : InfoFeatureStarter {

    override fun createOrGetFeature(): InfoFeatureApi {
        return InfoFeatureManager.createOrGetFeature(dependenciesFactory())
    }
}