 ...
 */
public class DefaultInfoFeatureFactory(
    private val di: DI,
) : InfoDecomposeFeatureFactory {

    override fun createOrGetFeature(context: ComponentContext): InfoFeatureApi {
        return di.direct.on(context).instance<InfoFeatureController>().fetchApi()
    }
}
