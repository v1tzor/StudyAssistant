...
package ru.aleshin.studyassistant.info.impl.presentation.ui
 ...
 */
@Immutable
internal enum class InfoLayoutMode {
    COMPACT,
    EXPANDED,
}

internal fun WindowAdaptiveInfo.fetchInfoLayoutMode(): InfoLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> InfoLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> InfoLayoutMode.EXPANDED
        else -> InfoLayoutMode.COMPACT
    }
}
