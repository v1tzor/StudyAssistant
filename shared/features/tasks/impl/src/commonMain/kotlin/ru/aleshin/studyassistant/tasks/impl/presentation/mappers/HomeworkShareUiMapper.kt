 ...
 */
internal fun HomeworkShare.mapToUi() = HomeworkShareUi(
    senderName = senderName,
    date = date,
    homeworks = homeworks.map { homework -> homework.mapToUi() },
)

internal fun HomeworkShareUi.mapToDomain() = HomeworkShare(
    senderName = senderName,
    date = date,
