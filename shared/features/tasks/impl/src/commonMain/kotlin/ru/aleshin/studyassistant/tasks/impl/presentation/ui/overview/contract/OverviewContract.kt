...
internal sealed class OverviewEvent : StoreEvent {
    ...
    data object ClearHomeworkShareLink : OverviewEvent()
    ...
    data object ClickAnalytics : OverviewEvent()
}
...
internal sealed class OverviewAction : StoreAction {
    ...
    data class UpdateHomeworkShareLink(val link: HomeworkShareLinkUi?) : OverviewAction()

    data class UpdateHomeworksProgress(val homeworkProgress: HomeworksCompleteProgressUi?) :
        OverviewAction()
...
internal sealed class OverviewOutput : BaseOutput {
    ...
    data object NavigateToAnalytics : OverviewOutput()
}
