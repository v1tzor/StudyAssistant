...
internal fun WindowAdaptiveInfo.fetchOverviewLayoutMode(): OverviewLayoutMode {
    return when {
        isCompactWidth || isCompactHeight -> OverviewLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout -> OverviewLayoutMode.EXPANDED
        else -> OverviewLayoutMode.COMPACT
    }
}
