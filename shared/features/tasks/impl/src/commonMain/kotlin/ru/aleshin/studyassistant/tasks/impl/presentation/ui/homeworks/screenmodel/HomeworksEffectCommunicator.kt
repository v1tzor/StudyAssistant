 ...
 */
internal interface HomeworksEffectCommunicator : EffectCommunicator<HomeworksEffect> {
    class Base : HomeworksEffectCommunicator, EffectCommunicator.Abstract<HomeworksEffect>()
}