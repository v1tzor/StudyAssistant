 ...
 */
internal interface ShareStateCommunicator : StateCommunicator<ShareViewState> {
    class Base : ShareStateCommunicator, StateCommunicator.Abstract<ShareViewState>(
        defaultState = ShareViewState()
    )
}