 ...
 */
internal interface TabsStateCommunicator : StateCommunicator<TabsViewState> {
    class Base : TabsStateCommunicator, StateCommunicator.Abstract<TabsViewState>(TabsViewState())
}