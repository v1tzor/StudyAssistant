 ...
 */
internal interface OrganizationStateCommunicator : StateCommunicator<OrganizationViewState> {
    class Base : OrganizationStateCommunicator, StateCommunicator.Abstract<OrganizationViewState>(
        defaultState = OrganizationViewState()
    )
}