...
internal interface OrganizationWorkProcessor :
    FlowWorkProcessor<OrganizationWorkCommand, OrganizationAction, OrganizationEffect, OrganizationOutput> {
    ...
    class Base(
        ...
        private fun saveEditModelWork(
            ...
            organizationInteractor.addOrUpdateOrganization(organization).handle(
                ...
                onRightAction = { emit(OutputResult(OrganizationOutput.NavigateToBack)) },
            )
        }
