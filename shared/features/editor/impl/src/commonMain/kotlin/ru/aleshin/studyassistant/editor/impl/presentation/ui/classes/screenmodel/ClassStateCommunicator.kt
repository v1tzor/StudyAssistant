 ...
 */
internal interface ClassStateCommunicator : StateCommunicator<ClassViewState> {
    class Base : ClassStateCommunicator, StateCommunicator.Abstract<ClassViewState>(
        defaultState = ClassViewState()
    )
}