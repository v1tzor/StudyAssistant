 ...
 */
internal interface EmployeeEditorStateCommunicator : StateCommunicator<EmployeeEditorViewState> {
    class Base : EmployeeEditorStateCommunicator, StateCommunicator.Abstract<EmployeeEditorViewState>(
        defaultState = EmployeeEditorViewState()
    )
}