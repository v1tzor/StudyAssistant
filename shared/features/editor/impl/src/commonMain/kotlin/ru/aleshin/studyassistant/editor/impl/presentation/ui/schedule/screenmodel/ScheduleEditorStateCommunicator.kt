 ...
 */
internal interface ScheduleEditorStateCommunicator : StateCommunicator<ScheduleEditorViewState> {

    class Base : ScheduleEditorStateCommunicator,
        StateCommunicator.Abstract<ScheduleEditorViewState>(defaultState = ScheduleEditorViewState())
}
