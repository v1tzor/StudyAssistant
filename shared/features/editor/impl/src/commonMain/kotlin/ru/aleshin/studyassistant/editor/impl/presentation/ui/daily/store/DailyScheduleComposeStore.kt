...
package ru.aleshin.studyassistant.editor.impl.presentation.ui.daily.store
 ...
 */
internal class DailyScheduleComposeStore(
    private val workProcessor: DailyScheduleWorkProcessor,
    stateCommunicator: StateCommunicator<DailyScheduleState>,
    effectCommunicator: EffectCommunicator<DailyScheduleEffect>,
    coroutineManager: CoroutineManager,
) : BaseComposeStore<DailyScheduleState, DailyScheduleEvent, DailyScheduleAction, DailyScheduleEffect, DailyScheduleInput, DailyScheduleOutput>(
    ...
    override suspend fun reduce(
        ...
        currentState: DailyScheduleState,
    ) = when (action) {
    ...
    ) : BaseComposeStore.Factory<DailyScheduleComposeStore, DailyScheduleState> {

        override fun create(savedState: DailyScheduleState): DailyScheduleComposeStore {
            return DailyScheduleComposeStore(
