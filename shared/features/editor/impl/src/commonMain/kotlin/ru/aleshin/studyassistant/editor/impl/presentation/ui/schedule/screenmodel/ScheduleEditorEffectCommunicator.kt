 ...
 */
internal interface ScheduleEditorEffectCommunicator : EffectCommunicator<ScheduleEditorEffect> {
    class Base : ScheduleEditorEffectCommunicator, EffectCommunicator.Abstract<ScheduleEditorEffect>()
}