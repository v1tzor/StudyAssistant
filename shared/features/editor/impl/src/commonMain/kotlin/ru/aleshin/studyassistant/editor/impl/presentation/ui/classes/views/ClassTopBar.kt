...
import ru.aleshin.studyassistant.editor.impl.resources.class_editor_header
...
internal fun ClassTopBar(
    ...
    TopAppBar(
        ...
        title = {
            TopAppBarTitle(
                header = stringResource(Res.string.class_editor_header),
