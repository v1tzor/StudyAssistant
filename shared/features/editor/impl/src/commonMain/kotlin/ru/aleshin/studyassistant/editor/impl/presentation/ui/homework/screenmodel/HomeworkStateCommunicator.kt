 ...
 */
internal interface HomeworkStateCommunicator : StateCommunicator<HomeworkViewState> {
    class Base : HomeworkStateCommunicator, StateCommunicator.Abstract<HomeworkViewState>(
        defaultState = HomeworkViewState()
    )
}