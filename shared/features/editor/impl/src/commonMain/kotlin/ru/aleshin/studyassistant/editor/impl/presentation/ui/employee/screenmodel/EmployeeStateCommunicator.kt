 ...
 */
internal interface EmployeeStateCommunicator : StateCommunicator<EmployeeViewState> {
    class Base : EmployeeStateCommunicator, StateCommunicator.Abstract<EmployeeViewState>(
        defaultState = EmployeeViewState()
    )
}