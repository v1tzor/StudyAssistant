 ...
 */
internal interface HomeworkEditorStateCommunicator : StateCommunicator<HomeworkEditorViewState> {
    class Base : HomeworkEditorStateCommunicator, StateCommunicator.Abstract<HomeworkEditorViewState>(
        defaultState = HomeworkEditorViewState()
    )
}