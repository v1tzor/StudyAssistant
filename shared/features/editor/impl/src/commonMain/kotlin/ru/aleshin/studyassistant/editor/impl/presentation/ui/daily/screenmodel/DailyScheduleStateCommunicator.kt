 ...
 */
internal interface DailyScheduleStateCommunicator : StateCommunicator<DailyScheduleViewState> {
    class Base : DailyScheduleStateCommunicator, StateCommunicator.Abstract<DailyScheduleViewState>(
        defaultState = DailyScheduleViewState()
    )
}