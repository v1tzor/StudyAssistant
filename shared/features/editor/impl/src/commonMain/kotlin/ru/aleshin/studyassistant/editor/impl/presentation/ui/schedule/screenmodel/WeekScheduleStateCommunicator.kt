 ...
 */
internal interface WeekScheduleStateCommunicator : StateCommunicator<WeekScheduleViewState> {

    class Base : WeekScheduleStateCommunicator,
        StateCommunicator.Abstract<WeekScheduleViewState>(defaultState = WeekScheduleViewState())
}