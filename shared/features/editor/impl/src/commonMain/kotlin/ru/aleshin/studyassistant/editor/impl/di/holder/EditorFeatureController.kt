 ...
 */
public class EditorFeatureController(
    dependencies: EditorFeatureDependencies,
) : BaseFeatureController<EditorFeatureApi, EditorFeatureDependencies>(
    dependencies = dependencies,
) {

    override fun DI.MainBuilder.buildDIGraph(dependencies: EditorFeatureDependencies) {
        ...
        bindSingleton<EditorFeatureApi> {
            object : EditorFeatureApi {
                override fun contentProviderFactory(): EditorContentProviderFactory = instance()
            }
        }
    }

    override fun fetchApi(): EditorFeatureApi = directDI.instance()
