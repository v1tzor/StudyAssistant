 ...
 */
internal interface OrganizationEditorStateCommunicator : StateCommunicator<OrganizationEditorViewState> {
    class Base : OrganizationEditorStateCommunicator, StateCommunicator.Abstract<OrganizationEditorViewState>(
        defaultState = OrganizationEditorViewState()
    )
}