 ...
 */
internal interface SubjectStateCommunicator : StateCommunicator<SubjectViewState> {
    class Base : SubjectStateCommunicator, StateCommunicator.Abstract<SubjectViewState>(
        defaultState = SubjectViewState()
    )
}