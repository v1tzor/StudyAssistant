 ...
 */
internal interface EmployeeEditorEffectCommunicator : EffectCommunicator<EmployeeEditorEffect> {
    class Base : EmployeeEditorEffectCommunicator, EffectCommunicator.Abstract<EmployeeEditorEffect>()
}
