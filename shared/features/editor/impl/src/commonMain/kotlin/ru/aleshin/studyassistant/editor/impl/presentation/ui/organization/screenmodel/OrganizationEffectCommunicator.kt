 ...
 */
internal interface OrganizationEffectCommunicator : EffectCommunicator<OrganizationEffect> {
    class Base : OrganizationEffectCommunicator, EffectCommunicator.Abstract<OrganizationEffect>()
}