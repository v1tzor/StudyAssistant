 ...
 */
internal interface SubjectEditorStateCommunicator : StateCommunicator<SubjectEditorViewState> {
    class Base : SubjectEditorStateCommunicator, StateCommunicator.Abstract<SubjectEditorViewState>(
        defaultState = SubjectEditorViewState()
    )
}
