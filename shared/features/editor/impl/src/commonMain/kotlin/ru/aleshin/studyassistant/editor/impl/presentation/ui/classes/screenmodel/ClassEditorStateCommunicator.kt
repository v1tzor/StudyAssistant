 ...
 */
internal interface ClassEditorStateCommunicator : StateCommunicator<ClassEditorViewState> {
    class Base : ClassEditorStateCommunicator, StateCommunicator.Abstract<ClassEditorViewState>(
        defaultState = ClassEditorViewState()
    )
}
