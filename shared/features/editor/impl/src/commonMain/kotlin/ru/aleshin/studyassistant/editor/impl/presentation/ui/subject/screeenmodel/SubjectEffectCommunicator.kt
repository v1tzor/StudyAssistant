 ...
 */
internal interface SubjectEffectCommunicator : EffectCommunicator<SubjectEffect> {
    class Base : SubjectEffectCommunicator, EffectCommunicator.Abstract<SubjectEffect>()
}