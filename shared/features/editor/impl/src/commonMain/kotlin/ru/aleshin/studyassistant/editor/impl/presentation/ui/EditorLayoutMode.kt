...
package ru.aleshin.studyassistant.editor.impl.presentation.ui
...
internal fun WindowAdaptiveInfo.fetchEditorLayoutMode(): EditorLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> EditorLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> EditorLayoutMode.EXPANDED
        else -> EditorLayoutMode.COMPACT
    }
}
