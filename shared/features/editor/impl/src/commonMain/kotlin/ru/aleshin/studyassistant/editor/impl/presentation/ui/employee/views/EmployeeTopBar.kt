...
import ru.aleshin.studyassistant.editor.impl.resources.employee_editor_header
...
internal fun EmployeeTopBar(
    ...
    TopAppBar(
        ...
        title = {
            TopAppBarTitle(
                header = stringResource(Res.string.employee_editor_header),
