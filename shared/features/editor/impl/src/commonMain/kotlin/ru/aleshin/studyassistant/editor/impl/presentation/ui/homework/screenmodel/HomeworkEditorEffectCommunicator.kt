 ...
 */
internal interface HomeworkEditorEffectCommunicator : EffectCommunicator<HomeworkEditorEffect> {
    class Base : HomeworkEditorEffectCommunicator, EffectCommunicator.Abstract<HomeworkEditorEffect>()
}