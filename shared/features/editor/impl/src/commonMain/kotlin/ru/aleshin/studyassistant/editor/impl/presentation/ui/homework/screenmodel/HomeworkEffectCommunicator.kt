 ...
 */
internal interface HomeworkEffectCommunicator : EffectCommunicator<HomeworkEffect> {
    class Base : HomeworkEffectCommunicator, EffectCommunicator.Abstract<HomeworkEffect>()
}