 ...
 */
internal interface DailyScheduleEffectCommunicator : EffectCommunicator<DailyScheduleEffect> {
    class Base : DailyScheduleEffectCommunicator, EffectCommunicator.Abstract<DailyScheduleEffect>()
}