 ...
 */
internal interface WeekScheduleEffectCommunicator : EffectCommunicator<WeekScheduleEffect> {
    class Base : WeekScheduleEffectCommunicator, EffectCommunicator.Abstract<WeekScheduleEffect>()
}