...
internal data class EditorStrings(
    ...
    val standardTimeValuesWarningData: String,
    ...
    val organizationStatusBody: String,
    ...
    companion object {
        val RUSSIAN = EditorStrings(
            ...
            standardTimeValuesWarningData = "Необходимо настроить стандартные значения",
            ...
            organizationStatusBody = "Выключает постояннный показ организации у занятий",
        ...
        val ENGLISH = EditorStrings(
            ...
            standardTimeValuesWarningData = "You need to configure the standard settings",
            ...
            organizationStatusBody = "Disables the permanent display of the organization for classes",
