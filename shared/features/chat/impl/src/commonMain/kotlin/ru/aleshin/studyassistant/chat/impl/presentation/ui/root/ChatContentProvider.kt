...
import ru.aleshin.studyassistant.chat.impl.presentation.ui.root.InternalChatFeatureComponent.Child
 ...
 */
public class ChatContentProvider internal constructor(
    private val component: InternalChatFeatureComponent,
            ...
            ChatTheme {
                ChildStack(
                    ...
                    when (val instance = child.instance) {
                        is Child.AssistantChild -> {
                            AssistantContent(instance.component)
                        }
                    }
                }
            }
