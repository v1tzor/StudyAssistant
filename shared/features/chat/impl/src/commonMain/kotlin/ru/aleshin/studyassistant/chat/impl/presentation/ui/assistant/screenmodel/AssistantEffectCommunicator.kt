 ...
 */
internal interface AssistantEffectCommunicator : EffectCommunicator<AssistantEffect> {
    class Base : AssistantEffectCommunicator, EffectCommunicator.Abstract<AssistantEffect>()
}