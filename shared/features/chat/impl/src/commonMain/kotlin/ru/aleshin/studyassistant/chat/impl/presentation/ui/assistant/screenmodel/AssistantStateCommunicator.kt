 ...
 */
internal interface AssistantStateCommunicator : StateCommunicator<AssistantViewState> {
    class Base : AssistantStateCommunicator, StateCommunicator.Abstract<AssistantViewState>(
        defaultState = AssistantViewState()
    )
}