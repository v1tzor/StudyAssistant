 ...
 */
internal interface SetupStateCommunicator : StateCommunicator<SetupViewState> {

    class Base : SetupStateCommunicator,
        StateCommunicator.Abstract<SetupViewState>(defaultState = SetupViewState())
}