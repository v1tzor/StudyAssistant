...
package ru.aleshin.studyassistant.preview.impl.presentation.ui
 ...
 */
@Immutable
internal enum class PreviewLayoutMode {
    COMPACT,
    EXPANDED,
}

internal fun WindowAdaptiveInfo.fetchPreviewLayoutMode(): PreviewLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> PreviewLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> PreviewLayoutMode.EXPANDED
        else -> PreviewLayoutMode.COMPACT
    }
}
