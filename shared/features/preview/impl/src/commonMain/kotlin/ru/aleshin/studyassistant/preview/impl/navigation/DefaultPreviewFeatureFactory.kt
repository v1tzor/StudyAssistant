 ...
 */
public class DefaultPreviewFeatureFactory(
    private val di: DI,
) : PreviewDecomposeFeatureFactory {

    override fun createOrGetFeature(context: ComponentContext): PreviewFeatureApi {
        return di.direct.on(context).instance<PreviewFeatureController>().fetchApi()
    }
}
