 ...
 */
internal interface AnalyticsErrorHandler : ErrorHandler<AnalyticsFailures> {

    class Base : AnalyticsErrorHandler {
        override fun handle(throwable: Throwable): AnalyticsFailures {
            return AnalyticsFailures.OtherError(throwable)
        }
    }
}
