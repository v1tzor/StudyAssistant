 ...
 */
internal fun AnalyticsComparison.mapToUi() = AnalyticsComparisonUi(
    plannedDurationPercent = plannedDurationPercent,
    commitmentsPercent = commitmentsPercent,
    onTimeRatePoints = onTimeRatePoints,
