 ...
 */
internal interface TabNavigationStateCommunicator : StateCommunicator<TabNavigationViewState> {
    class Base : TabNavigationStateCommunicator, StateCommunicator.Abstract<TabNavigationViewState>(
        defaultState = TabNavigationViewState
    )
}