...
package ru.aleshin.studyassistant.settings.impl.presentation.ui
...
internal fun WindowAdaptiveInfo.fetchSettingsLayoutMode(): SettingsLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> SettingsLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> SettingsLayoutMode.EXPANDED
