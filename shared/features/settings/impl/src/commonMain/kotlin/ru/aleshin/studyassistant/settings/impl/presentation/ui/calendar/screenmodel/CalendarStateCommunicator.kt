 ...
 */
internal interface CalendarStateCommunicator : StateCommunicator<CalendarViewState> {
    class Base : CalendarStateCommunicator, StateCommunicator.Abstract<CalendarViewState>(
        defaultState = CalendarViewState()
    )
}