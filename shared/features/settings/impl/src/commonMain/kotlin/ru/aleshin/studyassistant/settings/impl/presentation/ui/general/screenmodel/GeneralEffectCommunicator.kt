 ...
 */
internal interface GeneralEffectCommunicator : EffectCommunicator<GeneralEffect> {
    class Base : GeneralEffectCommunicator, EffectCommunicator.Abstract<GeneralEffect>()
}