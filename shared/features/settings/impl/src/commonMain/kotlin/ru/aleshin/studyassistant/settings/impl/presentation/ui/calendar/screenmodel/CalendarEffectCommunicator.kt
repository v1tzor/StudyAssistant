 ...
 */
internal interface CalendarEffectCommunicator : EffectCommunicator<CalendarEffect> {
    class Base : CalendarEffectCommunicator, EffectCommunicator.Abstract<CalendarEffect>()
}