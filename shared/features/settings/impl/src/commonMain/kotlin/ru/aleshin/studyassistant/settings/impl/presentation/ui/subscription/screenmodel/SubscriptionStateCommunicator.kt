 ...
 */
internal interface SubscriptionStateCommunicator : StateCommunicator<SubscriptionViewState> {
    class Base : SubscriptionStateCommunicator, StateCommunicator.Abstract<SubscriptionViewState>(
        defaultState = SubscriptionViewState()
    )
}