 ...
 */
internal interface NotificationEffectCommunicator : EffectCommunicator<NotificationEffect> {
    class Base : NotificationEffectCommunicator, EffectCommunicator.Abstract<NotificationEffect>()
}