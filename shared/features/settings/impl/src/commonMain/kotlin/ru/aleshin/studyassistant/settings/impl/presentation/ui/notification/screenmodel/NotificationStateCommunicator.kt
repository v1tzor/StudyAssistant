 ...
 */
internal interface NotificationStateCommunicator : StateCommunicator<NotificationViewState> {
    class Base : NotificationStateCommunicator, StateCommunicator.Abstract<NotificationViewState>(
        defaultState = NotificationViewState()
    )
}