 ...
 */
internal interface SubscriptionEffectCommunicator : EffectCommunicator<SubscriptionEffect> {
    class Base : SubscriptionEffectCommunicator, EffectCommunicator.Abstract<SubscriptionEffect>()
}