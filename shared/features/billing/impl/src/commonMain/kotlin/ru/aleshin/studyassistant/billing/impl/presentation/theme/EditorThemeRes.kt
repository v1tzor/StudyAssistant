...
import ru.aleshin.studyassistant.billing.impl.presentation.theme.tokens.BillingIcons
 ...
 */
internal object BillingThemeRes {

    val icons: BillingIcons
        @Composable get() = LocalBillingIcons.current

    val strings: BillingStrings
        @Composable get() = LocalBillingStrings.current
}