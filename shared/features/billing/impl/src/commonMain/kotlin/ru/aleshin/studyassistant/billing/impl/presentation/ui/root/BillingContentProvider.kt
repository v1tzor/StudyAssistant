...
import ru.aleshin.studyassistant.billing.impl.presentation.ui.subscribtion.SubscriptionContent
 ...
 */
public class BillingContentProvider internal constructor(
    private val component: InternalBillingFeatureComponent,
            ...
            BillingTheme {
                ChildStack(
                    ...
                    when (val instance = child.instance) {
                        is Child.SubscriptionChild -> {
                            SubscriptionContent(instance.component)
                        }
                    }
                }
            }
