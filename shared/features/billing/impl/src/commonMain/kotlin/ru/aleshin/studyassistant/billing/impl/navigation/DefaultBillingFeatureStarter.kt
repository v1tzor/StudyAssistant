 ...
 */
public class DefaultBillingFeatureStarter(
    private val dependenciesFactory: () -> BillingFeatureDependencies,
) : BillingFeatureStarter {

    override fun createOrGetFeature(): BillingFeatureApi {
        return BillingFeatureManager.createOrGetFeature(dependenciesFactory())
    }
}