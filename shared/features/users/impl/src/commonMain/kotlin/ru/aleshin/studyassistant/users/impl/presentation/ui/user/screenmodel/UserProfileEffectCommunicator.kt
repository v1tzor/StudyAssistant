 ...
 */
internal interface UserProfileEffectCommunicator : EffectCommunicator<UserProfileEffect> {
    class Base : UserProfileEffectCommunicator, EffectCommunicator.Abstract<UserProfileEffect>()
}