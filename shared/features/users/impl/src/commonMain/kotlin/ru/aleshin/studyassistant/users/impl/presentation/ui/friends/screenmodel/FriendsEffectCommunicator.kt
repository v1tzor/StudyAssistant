 ...
 */
internal interface FriendsEffectCommunicator : EffectCommunicator<FriendsEffect> {
    class Base : FriendsEffectCommunicator, EffectCommunicator.Abstract<FriendsEffect>()
}