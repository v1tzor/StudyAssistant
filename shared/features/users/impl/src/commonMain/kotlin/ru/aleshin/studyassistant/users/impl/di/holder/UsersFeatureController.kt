 ...
 */
public class UsersFeatureController(
    dependencies: UsersFeatureDependencies,
) : BaseFeatureController<UsersFeatureApi, UsersFeatureDependencies>(
    dependencies = dependencies,
) {

    override fun DI.MainBuilder.buildDIGraph(dependencies: UsersFeatureDependencies) {
        ...
        bindSingleton<UsersFeatureApi> {
            object : UsersFeatureApi {
                override fun contentProviderFactory(): UsersContentProviderFactory = instance()
            }
        }
    }

    override fun fetchApi(): UsersFeatureApi = directDI.instance()
