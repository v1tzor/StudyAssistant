 ...
 */
internal interface FriendsStateCommunicator : StateCommunicator<FriendsViewState> {
    class Base : FriendsStateCommunicator, StateCommunicator.Abstract<FriendsViewState>(
        defaultState = FriendsViewState()
    )
}