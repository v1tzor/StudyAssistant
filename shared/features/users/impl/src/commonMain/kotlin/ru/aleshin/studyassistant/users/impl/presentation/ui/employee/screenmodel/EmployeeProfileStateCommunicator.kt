 ...
 */
internal interface EmployeeProfileStateCommunicator : StateCommunicator<EmployeeProfileViewState> {
    class Base : EmployeeProfileStateCommunicator, StateCommunicator.Abstract<EmployeeProfileViewState>(
        defaultState = EmployeeProfileViewState()
    )
}