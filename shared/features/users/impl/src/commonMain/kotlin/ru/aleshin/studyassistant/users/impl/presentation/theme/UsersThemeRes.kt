...
import ru.aleshin.studyassistant.users.impl.presentation.theme.tokens.UsersIcons
import ru.aleshin.studyassistant.users.impl.presentation.theme.tokens.UsersStrings

/**
 * @author Stanislav Aleshin on 27.05.2024.
 */
internal object UsersThemeRes {

    val icons: UsersIcons
        @Composable get() = LocalUsersIcons.current

    val strings: UsersStrings
        @Composable get() = LocalUsersStrings.current
}