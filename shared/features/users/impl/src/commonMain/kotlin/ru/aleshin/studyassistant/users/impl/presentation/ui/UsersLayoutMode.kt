...
package ru.aleshin.studyassistant.users.impl.presentation.ui
 ...
 */
@Immutable
internal enum class UsersLayoutMode {
    COMPACT,
    EXPANDED,
}

internal fun WindowAdaptiveInfo.fetchUsersLayoutMode(): UsersLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> UsersLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> UsersLayoutMode.EXPANDED
        else -> UsersLayoutMode.COMPACT
    }
}
