 ...
 */
public class DefaultUsersFeatureFactory(
    private val di: DI,
) : UsersDecomposeFeatureFactory {

    override fun createOrGetFeature(context: ComponentContext): UsersFeatureApi {
        return di.direct.on(context).instance<UsersFeatureController>().fetchApi()
    }
}
