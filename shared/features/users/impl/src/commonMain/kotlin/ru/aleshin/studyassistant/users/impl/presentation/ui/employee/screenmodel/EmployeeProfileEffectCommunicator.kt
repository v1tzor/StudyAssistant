 ...
 */
internal interface EmployeeProfileEffectCommunicator : EffectCommunicator<EmployeeProfileEffect> {
    class Base : EmployeeProfileEffectCommunicator, EffectCommunicator.Abstract<EmployeeProfileEffect>()
}