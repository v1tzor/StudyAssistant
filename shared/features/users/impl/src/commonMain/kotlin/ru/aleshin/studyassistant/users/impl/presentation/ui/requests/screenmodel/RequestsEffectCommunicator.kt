 ...
 */
internal interface RequestsEffectCommunicator : EffectCommunicator<RequestsEffect> {
    class Base : RequestsEffectCommunicator, EffectCommunicator.Abstract<RequestsEffect>()
}