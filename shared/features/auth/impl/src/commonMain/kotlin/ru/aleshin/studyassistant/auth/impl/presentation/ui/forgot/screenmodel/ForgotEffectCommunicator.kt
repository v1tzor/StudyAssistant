 ...
 */
internal interface ForgotEffectCommunicator : EffectCommunicator<ForgotEffect> {

    class Base : ForgotEffectCommunicator,
        EffectCommunicator.Abstract<ForgotEffect>()
}