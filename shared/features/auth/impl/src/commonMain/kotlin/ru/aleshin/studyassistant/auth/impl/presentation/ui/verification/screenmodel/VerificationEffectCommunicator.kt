 ...
 */
internal interface VerificationEffectCommunicator : EffectCommunicator<VerificationEffect> {
    class Base : VerificationEffectCommunicator, EffectCommunicator.Abstract<VerificationEffect>()
}