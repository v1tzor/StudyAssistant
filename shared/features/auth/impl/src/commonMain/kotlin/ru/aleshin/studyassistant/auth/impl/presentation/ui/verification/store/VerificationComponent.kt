...
/**
 * @author Stanislav Aleshin on 17.08.2025.
 */
internal abstract class VerificationComponent(
    componentContext: ComponentContext
) : ChildComponent(componentContext) {

    abstract val store: VerificationComposeStore

    class Default(
        storeFactory: VerificationComposeStore.Factory,
        componentContext: ComponentContext,
        outputConsumer: OutputConsumer<VerificationOutput>,
    ) : VerificationComponent(componentContext) {

        private companion object Companion {
            const val COMPONENT_KEY = "AUTH_VERIFICATION"
        }
