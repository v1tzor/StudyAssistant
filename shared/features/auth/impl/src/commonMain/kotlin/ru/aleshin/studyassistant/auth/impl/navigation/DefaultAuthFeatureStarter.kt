 ...
 */
public class DefaultAuthFeatureStarter(
    private val dependenciesFactory: () -> AuthFeatureDependencies,
) : AuthFeatureStarter {

    override fun createOrGetFeature(): AuthFeatureApi {
        return AuthFeatureManager.createOrGetFeature(dependenciesFactory())
    }
}