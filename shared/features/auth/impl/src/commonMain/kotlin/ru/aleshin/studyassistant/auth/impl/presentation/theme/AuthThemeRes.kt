...
import ru.aleshin.studyassistant.auth.impl.presentation.theme.tokens.AuthIcons
 ...
 */
internal object AuthThemeRes {

    val icons: AuthIcons
        @Composable get() = LocalAuthIcons.current

    val strings: AuthStrings
        @Composable get() = LocalAuthStrings.current
}