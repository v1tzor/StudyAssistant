 ...
 */
internal interface LoginStateCommunicator : StateCommunicator<LoginViewState> {

    class Base : LoginStateCommunicator,
        StateCommunicator.Abstract<LoginViewState>(defaultState = LoginViewState())
}