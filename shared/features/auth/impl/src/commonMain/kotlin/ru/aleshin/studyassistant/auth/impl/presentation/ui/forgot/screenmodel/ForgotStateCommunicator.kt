 ...
 */
internal interface ForgotStateCommunicator : StateCommunicator<ForgotViewState> {

    class Base : ForgotStateCommunicator,
        StateCommunicator.Abstract<ForgotViewState>(defaultState = ForgotViewState())
}