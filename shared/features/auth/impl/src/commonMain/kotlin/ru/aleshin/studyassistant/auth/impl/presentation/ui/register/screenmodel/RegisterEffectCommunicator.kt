 ...
 */
internal interface RegisterEffectCommunicator : EffectCommunicator<RegisterEffect> {

    class Base : RegisterEffectCommunicator,
        EffectCommunicator.Abstract<RegisterEffect>()
}