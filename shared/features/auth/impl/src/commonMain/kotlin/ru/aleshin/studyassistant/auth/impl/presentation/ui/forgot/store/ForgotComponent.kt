 ...
 */
internal abstract class ForgotComponent(
    componentContext: ComponentContext
) : ChildComponent(componentContext) {

    abstract val store: ForgotComposeStore

    class Default(
        storeFactory: ForgotComposeStore.Factory,
        componentContext: ComponentContext,
        outputConsumer: OutputConsumer<ForgotOutput>,
    ) : ForgotComponent(componentContext) {

        private companion object Companion {
            const val COMPONENT_KEY = "AUTH_FORGOT"
        }
