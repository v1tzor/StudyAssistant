 ...
 */
internal abstract class RegisterComponent(
    componentContext: ComponentContext
) : ChildComponent(componentContext) {

    abstract val store: RegisterComposeStore

    class Default(
        storeFactory: RegisterComposeStore.Factory,
        componentContext: ComponentContext,
        outputConsumer: OutputConsumer<RegisterOutput>,
    ) : RegisterComponent(componentContext) {

        private companion object Companion {
            const val COMPONENT_KEY = "AUTH_REGISTER"
        }
