 ...
 */
internal interface VerificationStateCommunicator : StateCommunicator<VerificationViewState> {
    class Base : VerificationStateCommunicator, StateCommunicator.Abstract<VerificationViewState>(
        defaultState = VerificationViewState()
    )
}