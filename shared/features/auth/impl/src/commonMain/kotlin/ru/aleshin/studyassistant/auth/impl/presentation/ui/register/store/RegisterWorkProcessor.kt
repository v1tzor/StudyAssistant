...
internal interface RegisterWorkProcessor :
    FlowWorkProcessor<RegisterWorkCommand, RegisterAction, RegisterEffect, RegisterOutput> {
    ...
    class Base(
        ...
        private fun registerNewAccountWork(credentials: RegisterCredentialsUi) = flow<RegisterWorkResult> {
            ...
            authInteractor.registerNewAccount(credentials.mapToDomain(), device).handle(
                ...
                onRightAction = {
                    emit(OutputResult(RegisterOutput.NavigateToVerification))
                },
            )
        }.onStart {
...
internal typealias RegisterWorkResult = WorkResult<RegisterAction, RegisterEffect, RegisterOutput>