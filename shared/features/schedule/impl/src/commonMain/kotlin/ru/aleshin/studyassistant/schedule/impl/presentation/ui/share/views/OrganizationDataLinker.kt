...
import ru.aleshin.studyassistant.core.presentation.mappers.organizations.mapToShort
...
import ru.aleshin.studyassistant.schedule.impl.resources.shared_employees_header
import ru.aleshin.studyassistant.schedule.impl.resources.shared_organization_header
import ru.aleshin.studyassistant.schedule.impl.resources.shared_subjects_header
...
private fun OrganizationsSelectorSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.shared_organization_header),
                ...
                HorizontalPager(
                    ...
                    if (openOrganizationLinkerSheet) {
                        OrganizationLinkerBottomSheet(
                            selected = linkData.linkedOrganization?.mapToShort(),
...
private fun SubjectsLinkerSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.shared_subjects_header),
            color = MaterialTheme.colorScheme.onSurface,
            maxLines = 1,
            style = MaterialTheme.typography.titleMedium,
        )
...
private fun EmployeeLinkerSection(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.shared_employees_header),
            color = MaterialTheme.colorScheme.onSurface,
            maxLines = 1,
            style = MaterialTheme.typography.titleMedium,
        )
