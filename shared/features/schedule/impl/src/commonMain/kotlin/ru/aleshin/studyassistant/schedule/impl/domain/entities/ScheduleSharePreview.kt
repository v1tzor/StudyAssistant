 ...
 */
internal data class ScheduleSharePreview(
    val claim: ScheduleShareClaim,
    val organizations: List<OrganizationShort>,
    val links: List<ScheduleOrganizationLink>,
    val schedules: List<BaseSchedule>,
