 ...
 */
internal data class ScheduleOrganizationLink(
    val sharedOrganization: MediatedOrganization,
    val linkedOrganization: Organization? = null,
    val linkedSubjects: Map<UID, Subject> = emptyMap(),
    val linkedTeachers: Map<UID, Employee> = emptyMap(),
)
