...
internal data class ScheduleStrings(
    ...
    val sharedScheduleSenderHeader: String,
    val sharedScheduleHeader: String,
    val newAndLinkedDataSectionLabel: String,
    val sharedOrganizationHeader: String,
    val organizationLinkerDialogHeader: String,
    val organizationLinkerDialogTitle: String,
    val sharedSubjectsHeader: String,
    val subjectLinkerDialogHeader: String,
    val subjectLinkerDialogTitle: String,
    val sharedEmployeesHeader: String,
    val employeeLinkerDialogHeader: String,
    val employeeLinkerDialogTitle: String,
    val linkButtonTitle: String,
    val unlinkButtonTitle: String,
    val firstWeekTitle: String,
    val secondWeekTitle: String,
    val thirtyWeekTitle: String,
    val acceptSharedScheduleButtonTitle: String,
    val rejectSharedScheduleButtonTitle: String,
    ...
    companion object {
        val RUSSIAN = ScheduleStrings(
            ...
            sharedScheduleSenderHeader = "Отправитель",
            sharedScheduleHeader = "Расписание",
            newAndLinkedDataSectionLabel = "Новые и привязанные данные",
            sharedOrganizationHeader = "Организации",
            organizationLinkerDialogHeader = "Организации",
            organizationLinkerDialogTitle = "Если организация уже создана, выберите её, чтобы привязать",
            sharedSubjectsHeader = "Предметы",
            subjectLinkerDialogHeader = "Предметы",
            subjectLinkerDialogTitle = "Если предмет уже создан, выберите его, чтобы привязать",
            sharedEmployeesHeader = "Сотрудники",
            employeeLinkerDialogHeader = "Сотрудники",
            employeeLinkerDialogTitle = "Если профиль сотрудника уже создан, выберите его, чтобы привязать",
            linkButtonTitle = "Привязать",
            unlinkButtonTitle = "Отвязать",
            firstWeekTitle = "1 неделя",
            secondWeekTitle = "2 неделя",
            thirtyWeekTitle = "3 неделя",
            acceptSharedScheduleButtonTitle = "Принять",
            rejectSharedScheduleButtonTitle = "Отклонить",
            agoSuffix = "назад",
        ...
        val ENGLISH = ScheduleStrings(
            ...
            shareHeader = "Sharing a schedule",
            ...
            sharedScheduleSenderHeader = "Sender",
            sharedScheduleHeader = "Schedule",
            newAndLinkedDataSectionLabel = "New and linked data",
            sharedOrganizationHeader = "Organizations",
            organizationLinkerDialogHeader = "Organizations",
            organizationLinkerDialogTitle = "If an organization has already been created, select it to link it",
            sharedSubjectsHeader = "Subjects",
            subjectLinkerDialogHeader = "Subjects",
            subjectLinkerDialogTitle = "If the subject has already been created, select it to link it",
            sharedEmployeesHeader = "Employees",
            employeeLinkerDialogHeader = "Employees",
            employeeLinkerDialogTitle = "If the employee's profile has already been created, select it to link it",
            linkButtonTitle = "Link",
            unlinkButtonTitle = "Unlink",
            firstWeekTitle = "1 week",
            secondWeekTitle = "2 week",
            thirtyWeekTitle = "3 week",
            acceptSharedScheduleButtonTitle = "Accept",
            rejectSharedScheduleButtonTitle = "Reject",
            agoSuffix = "ago",
