 ...
 */
public class DefaultScheduleFeatureFactory(
    private val di: DI,
) : ScheduleDecomposeFeatureFactory {

    override fun createOrGetFeature(context: ComponentContext): ScheduleFeatureApi {
        return di.direct.on(context).instance<ScheduleFeatureController>().fetchApi()
    }
}
