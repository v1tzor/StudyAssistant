 ...
 */
@Immutable
internal enum class ShareLayoutMode {
    COMPACT,
    EXPANDED,
}

internal fun WindowAdaptiveInfo.fetchShareLayoutMode(): ShareLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> ShareLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> ShareLayoutMode.EXPANDED
        else -> ShareLayoutMode.COMPACT
    }
}
