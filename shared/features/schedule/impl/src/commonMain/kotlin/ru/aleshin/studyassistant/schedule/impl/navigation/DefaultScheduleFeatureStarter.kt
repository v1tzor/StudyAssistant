 ...
 */
public class DefaultScheduleFeatureStarter(
    private val dependenciesFactory: () -> ScheduleFeatureDependencies,
) : ScheduleFeatureStarter {

    override fun createOrGetFeature(): ScheduleFeatureApi {
        return ScheduleFeatureManager.createOrGetFeature(dependenciesFactory())
    }
}