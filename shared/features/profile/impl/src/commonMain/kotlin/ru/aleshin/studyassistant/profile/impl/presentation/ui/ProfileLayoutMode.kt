...
internal enum class ProfileLayoutMode {
    ...
    val showScaffoldTopBar: Boolean
        get() = this == COMPACT
}

internal fun WindowAdaptiveInfo.fetchProfileLayoutMode(): ProfileLayoutMode {
    return when {
        isCompactWidth || isCompactHeight || isTabletopPosture -> ProfileLayoutMode.COMPACT
        useNavigationRail || useExpandedLayout || isBookPosture -> ProfileLayoutMode.EXPANDED
        else -> ProfileLayoutMode.COMPACT
    }
}
