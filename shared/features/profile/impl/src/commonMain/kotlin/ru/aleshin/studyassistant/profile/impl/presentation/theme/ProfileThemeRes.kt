...
import ru.aleshin.studyassistant.profile.impl.presentation.theme.tokens.ProfileIcons
 ...
 */
internal object ProfileThemeRes {

    val icons: ProfileIcons
        @Composable get() = LocalProfileIcons.current

    val strings: ProfileStrings
        @Composable get() = LocalProfileStrings.current
}
