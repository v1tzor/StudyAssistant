 ...
 */
internal interface ProfileStateCommunicator : StateCommunicator<ProfileViewState> {
    class Base : ProfileStateCommunicator, StateCommunicator.Abstract<ProfileViewState>(
