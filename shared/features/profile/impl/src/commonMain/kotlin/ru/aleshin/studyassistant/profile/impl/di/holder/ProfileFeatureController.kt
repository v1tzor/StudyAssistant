...
) : BaseFeatureController<ProfileFeatureApi, ProfileFeatureDependencies>(
    dependencies = dependencies
) {

    override fun DI.MainBuilder.buildDIGraph(dependencies: ProfileFeatureDependencies) {
        ...
        bindSingleton<ProfileFeatureApi> {
            object : ProfileFeatureApi {
                override fun contentProviderFactory(): ProfileContentProviderFactory = instance()
            }
        }
    }

    override fun fetchApi(): ProfileFeatureApi {
        return directDI.instance<ProfileFeatureApi>()
    }
