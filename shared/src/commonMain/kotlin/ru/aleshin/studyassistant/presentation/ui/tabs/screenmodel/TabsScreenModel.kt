 ...
 */
package ru.aleshin.studyassistant.presentation.ui.tabs.screenmodel
...
import ru.aleshin.studyassistant.presentation.ui.tabs.contract.TabsAction
...
class TabsScreenModel(
    ...
    private suspend fun WorkScope<TabsViewState, TabsAction, TabsEffect>.changeTabItem(
        ...
        onAction: MainScreenProvider.() -> Screen,
...
@Composable
fun Screen.rememberTabsScreenModel(): TabsScreenModel {
    return rememberScreenModel { MainDependenciesGraph.instance<TabsScreenModel>() }
}
