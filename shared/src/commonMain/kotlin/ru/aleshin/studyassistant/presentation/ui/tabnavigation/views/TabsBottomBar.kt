 ...
 */
package ru.aleshin.studyassistant.presentation.ui.tabnavigation.views
...
internal fun TabsComponent.TabsChild.mapToItem() = when (this) {
    is TabsComponent.TabsChild.ScheduleChild -> TabsBottomBarItems.SCHEDULE
    is TabsComponent.TabsChild.TasksChild -> TabsBottomBarItems.TASKS
    is TabsComponent.TabsChild.ChatChild -> TabsBottomBarItems.CHAT
    is TabsComponent.TabsChild.InfoChild -> TabsBottomBarItems.INFO
    is TabsComponent.TabsChild.ProfileChild -> TabsBottomBarItems.PROFILE
}