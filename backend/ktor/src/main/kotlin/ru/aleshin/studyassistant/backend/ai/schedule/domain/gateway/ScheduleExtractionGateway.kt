...
package ru.aleshin.studyassistant.backend.ai.schedule.domain.gateway
 ...
 */
interface ScheduleExtractionGateway {

    suspend fun extract(request: ScheduleExtractionRequest): ScheduleProviderResult
}
