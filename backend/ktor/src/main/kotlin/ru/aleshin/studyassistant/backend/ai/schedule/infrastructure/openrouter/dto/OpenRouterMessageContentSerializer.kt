...
internal object OpenRouterMessageContentSerializer : KSerializer<String?> {

    override val descriptor: SerialDescriptor =
        PrimitiveSerialDescriptor("OpenRouterMessageContent", PrimitiveKind.STRING).nullable
        ...
        return when (val element = jsonDecoder.decodeJsonElement()) {
            ...
            is JsonArray -> element.joinToString(separator = "") { part ->
                when (part) {
                    ...
                    is JsonObject -> (part["text"] as? JsonPrimitive)?.content.orEmpty()
                    else -> ""
                }
